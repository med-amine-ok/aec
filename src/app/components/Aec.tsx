...
export default function Aec() {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div
        id="aec-about"
        className="relative min-h-screen w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 py-10 overflow-hidden"
      >
        {/* Background stamp image with space on all 4 sides */}
        <img
          src="/timbre.jpg"
          alt="Algerian stamp background"
        ...
        <div className="relative w-[85%] md:w-1/2 max-w-4xl h-[260px] sm:h-[340px] md:h-[520px]" style={{ zIndex: 2 }}>
          {/* The 3D Maqam Echahid model is rendered as a fixed overlay and aligns with this space */}
        </div>

        {/* Slogan + Description */}
        <div className="relative w-[90%] md:w-1/2 px-6 flex flex-col items-center md:items-start text-center md:text-left" style={{ zIndex: 2 }}>
          <div className="w-full max-w-xl">
            <h2 className="aec text-2xl md:text-5xl font-Request font-semibold text-[#e6f7ff] mb-6">
              WHAT IS AEC
            </h2>
